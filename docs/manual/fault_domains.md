...
This procedure prevents temporary unavailability which may happen with sustained trffic when data distributor and master are being reallocated while redundancy mode is changed.
