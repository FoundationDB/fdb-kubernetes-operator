...
| TotalSnapshotBytes | TotalSnapshotBytes is the total size in bytes of all snapshot files recorded in the backup metadata. Drops to zero once every snapshot covering the live restorable range has been expired. | *int64 | false |
