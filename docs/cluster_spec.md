...
| remoteStorage | RemoteStorage defines if the cluster is using remote storage. This is used to determine how the operator should handle pod replacements. | *bool | false |
