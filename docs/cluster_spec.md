...
| maxZonesWithUnavailablePods | MaxZonesWithUnavailablePods defines the maximum number of zones that can have unavailable pods during the update process. When set to 0 there is no limit on the number of zones with unavailable pods. | *int | false |
