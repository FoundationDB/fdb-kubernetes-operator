...
var _ = Describe("Operator", Label("e2e", "pr"), func() {
	...
	FWhen("setting 2 logs per disk", func() {
		...
		BeforeEach(func() {
			...
			validateProcessesCount(fdbCluster, fdbv1beta2.ProcessRoleLog, expectedPodCnt, expectedLogProcessesCnt)
		})
