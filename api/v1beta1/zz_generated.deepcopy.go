...
func (in *ConnectionString) DeepCopyInto(out *ConnectionString) {
	*out = *in
	if in.Coordinators != nil {
		...
		*out = make(ProcessAddressSlice, len(*in))
		for i := range *in {
...
func (in *FoundationDBStatusProcessInfo) DeepCopyInto(out *FoundationDBStatusProcessInfo) {
	*out = *in
	if in.ProcessAddresses != nil {
		in, out := &in.ProcessAddresses, &out.ProcessAddresses
		*out = make(ProcessAddressSlice, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in ProcessAddressSlice) DeepCopyInto(out *ProcessAddressSlice) {
	{
		in := &in
		*out = make(ProcessAddressSlice, len(*in))
		for i := range *in {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProcessAddressSlice.
func (in ProcessAddressSlice) DeepCopy() ProcessAddressSlice {
	if in == nil {
		return nil
	}
	out := new(ProcessAddressSlice)
	in.DeepCopyInto(out)
	return *out
}
