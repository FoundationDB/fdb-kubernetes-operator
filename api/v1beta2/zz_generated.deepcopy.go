...
func (in *FoundationDBClusterSpec) DeepCopyInto(out *FoundationDBClusterSpec) {
	*out = *in
	...
	if in.ProcessesConfigs != nil {
		in, out := &in.ProcessesConfigs, &out.ProcessesConfigs
		*out = make([]ProcessesConfig, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ProcessesConfig) DeepCopyInto(out *ProcessesConfig) {
	*out = *in
	in.Settings.DeepCopyInto(&out.Settings)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ProcessesConfig.
func (in *ProcessesConfig) DeepCopy() *ProcessesConfig {
	if in == nil {
		return nil
	}
	out := new(ProcessesConfig)
	in.DeepCopyInto(out)
	return out
}
